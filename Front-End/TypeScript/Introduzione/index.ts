...
const me:{name:string, surname:string, age?:number, skills?:Array<string>} = {
    name: "Enrico",
    surname: "Copetti",
    age: 15
}
...
function whoIsBigger(num1:number, num2:number):(number | string) {
    if (num1 > num2) {
        return num1
    } else if (num2 > num1) {
        return num2
...
function splitMe(stringa:string):Array<string> {
...
function deleteOne(stringa:string, bool:boolean):string {
...
function onlyLetters(stringa:string):string {
...
function isThisAnEmail(email:string):boolean {
...
function rollTheDices(num:number):Object {
  const object = {
    sum: 0,
    values: [] as number[]
  }
...
function howManyDays(data:Date):string {
  let oggi = new Date();
...
function deleteProp(oggetto:{[key: string]: any}, stringa:string):Object {
  if (oggetto[stringa]) {
...
function onlyTheYears():Array<string> {
...
function onlyInLastMillennium():Array<Object> {
...
function sumAllTheYears():number {
  let sum = 0;
  for (let i = 0; i < movies.length; i++) {
...
function searchByTitle(title:string):Array<Object> {
...
function searchAndDivide(title:string):{match:Array<Object>, unmatch:Array<Object>} {
  const result = {
    match:[] as Movie[],
    unmatch:[] as Movie[]
  }

  movies.forEach((element:Movie) => {
...
function removeIndex(num:number):Array<Object> {
...
function resultTd():Array<string> {
  let array = [] as string[];
  td.forEach(element => {
...
function addElement(stringa:string):void {
...
function addClass(classe:string) {
  tr.forEach(element => {
