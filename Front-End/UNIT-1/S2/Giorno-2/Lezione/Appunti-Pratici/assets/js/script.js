...
// Un oggetto potrebbe anche essere definito inizialmente vuoto, metodologia deprecata
const nuovoOggetto = {};

// Stampa oggetto (a video e in console) - *** LA CONSOLE MOSTRERA' SEMPRE LO STATO ULTIMO DELL'OGGETTO, QUINDI CON EVENTUALI MODIFICHE ***
...
console.log(studente); // Tutti e due i console.log risultano uguali all'ultima modifica perché la console printa dopo la compilazione
...
// Rimozione di proprietà da un oggetto
delete studente.webcam;

console.log(studente);

// Creazione nuovi oggetti a partire dall'oggetto principale
const studente2 = studente; // Con l'operatore di assegnazione, viene creato un clone bidirezionale, quindi ogni cambiamento in studente2 avrà effetto anche su studente - DEPRECATO!

// Metodi corretti di copia di un oggetto in un altro
const studente3 = Object.assign(studente); // Metodo di assegnazione delle caratteristiche di un oggetto ad un altro oggetto
// ATTENZIONE!!! L'oggetto diventa un modulo, che sarà gestito in un altro modo
const studente4 = { ...studente }; // Spread operator - Metodo preferito perché crea una copia dell'oggetto senza intaccare le caratteristiche né dell'oggetto originario né del nuovo oggetto
